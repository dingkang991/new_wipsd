...
/*xxx add*/
/*Note1:maybe hfa384_rx_frame is right*/
/*Note2: 所使用的网卡不一样，接收到的帧的前端封装字段也不一样吧?*/
/*xxx end*/

/*xxx add*/
/*copy from project 11n driver /core/net80211/if_wavelan_ieee.h struct wi_rx_frame function*/
/*
*struct wi_rx_frame {
*	 *
...
*	u_int16_t	wi_rsvd1;
*/
/*below total: bytes(2+2+2+1+1+1+1+2+2= 14)*/
/*down total:  bytes(2+2+2+4+1+1+2= 14)*/
/*the judge of the protocal defined the standard header is right */
/*xxx end*/
...
#define WLAN_FC_TODS 0x01
//#define WLAN_FC_FROMDS BIT(9)
#define WLAN_FC_FROMDS 0x02
#define WLAN_FC_WDS 0x03
#define WLAN_FC_ADHOC 0x0
...
#define WLAN_FC_TYPE_CTRL 0x04
#define WLAN_FC_TYPE_DATA 0x08

/*wdm add*/
#define WLAN_FC1_NODS 0x00 /*sta->sta*/
#define WLAN_FC1_TODS 0x01 /*sta->ap*/
#define WLAN_FC1_FROMDS 0x02 /*ap->sta*/
#define WLAN_FC1_DSTODS 0x03 /*ap->ap*/
/*end*/

/* management */
#define WLAN_FC_STYPE_ASSOC_REQ 0x0
#define WLAN_FC_STYPE_ASSOC_RESP 0x1
#define WLAN_FC_STYPE_REASSOC_REQ 0x2
#define WLAN_FC_STYPE_REASSOC_RESP 0x3
#define WLAN_FC_STYPE_PROBE_REQ 0x4
#define WLAN_FC_STYPE_PROBE_RESP 0x5
#define WLAN_FC_STYPE_BEACON 0x8
#define WLAN_FC_STYPE_ATIM 0x9
#define WLAN_FC_STYPE_DISASSOC 0xa
#define WLAN_FC_STYPE_AUTH 0xb
#define WLAN_FC_STYPE_DEAUTH 0xc
#define WLAN_FC02_STYPE_ASSOC_REQ 0x0
#define WLAN_FC02_STYPE_ASSOC_RESP 0x10
#define WLAN_FC02_STYPE_REASSOC_REQ 0x20
#define WLAN_FC02_STYPE_REASSOC_RESP 0x30
#define WLAN_FC02_STYPE_PROBE_REQ 0x40
#define WLAN_FC02_STYPE_PROBE_RESP 0x50
#define WLAN_FC02_STYPE_BEACON 0x80
#define WLAN_FC02_STYPE_ATIM 0x90
#define WLAN_FC02_STYPE_DISASSOC 0xa0
#define WLAN_FC02_STYPE_AUTH 0xb0
#define WLAN_FC02_STYPE_DEAUTH 0xc0


/* control */
#define WLAN_FC_STYPE_PSPOLL 0xa0
#define WLAN_FC_STYPE_RTS 0xb0
#define WLAN_FC_STYPE_CTS 0xc0
#define WLAN_FC_STYPE_ACK 0xd0
#define WLAN_FC_STYPE_CFEND 0xe0
#define WLAN_FC_STYPE_CFENDACK 0xf0

/* data */
#define WLAN_FC02_STYPE_DATA 0x00
#define WLAN_FC02_STYPE_DATA_CFACK 0x10
#define WLAN_FC02_STYPE_DATA_CFPOLL 0x20
#define WLAN_FC02_STYPE_DATA_CFACKPOLL 0x30
#define WLAN_FC02_STYPE_NULLFUNC 0x40
#define WLAN_FC02_STYPE_CFACK 0x50
#define WLAN_FC02_STYPE_CFPOLL 0x60
#define WLAN_FC02_STYPE_CFACKPOLL 0x70
#define WLAN_FC02_STYPE_QOS_DATA 0x80
#define WLAN_FC02_STYPE_QOS_DATA_CFACK 0x90
#define WLAN_FC02_STYPE_QOS_DATA_CFPOLL 0xA0
#define WLAN_FC02_STYPE_QOS_DATA_CFACKPOLL 0xB0
#define WLAN_FC02_STYPE_QOS_NULLFUNC 0xC0
#define WLAN_FC02_STYPE_QOS_CFACK 0xD0
#define WLAN_FC02_STYPE_QOS_CFPOLL 0xE0
#define WLAN_FC02_STYPE_QOS_CFACKPOLL 0xF0
...
#define HOSTAP_CRYPT_ALG_NAME_LEN 32
