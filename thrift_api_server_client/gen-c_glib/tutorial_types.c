...
mapconstant_constant (void)
{
  ...
  if (constant == NULL)
  {
    gchar * mapconstant1key = g_strdup ("hello");
    gchar * mapconstant1val = g_strdup ("world");
    gchar * mapconstant2key = g_strdup ("goodnight");
    gchar * mapconstant2val = g_strdup ("moon");

    constant = g_hash_table_new_full (g_str_hash, g_str_equal, g_free, g_free);
    g_hash_table_insert (constant, mapconstant1key, mapconstant1val);
    g_hash_table_insert (constant, mapconstant2key, mapconstant2val);
  }
  return constant;
}
...
/* reads a calculator_get_log_type1_args object */
static gint32
calculator_get_log_type1_args_read (ThriftStruct *object, ThriftProtocol *protocol, GError **error)
{
  gint32 ret;
  gint32 xfer = 0;
  gchar *name = NULL;
  ...
  guint32 len = 0;
  gpointer data = NULL;
  CalculatorGetLogType1Args * this_object = CALCULATOR_GET_LOG_TYPE1_ARGS(object);
...
static gint32
calculator_get_log_type1_args_write (ThriftStruct *object, ThriftProtocol *protocol, GError **error)
{
  gint32 ret;
  gint32 xfer = 0;
  ...
  CalculatorGetLogType1Args * this_object = CALCULATOR_GET_LOG_TYPE1_ARGS(object);
  THRIFT_UNUSED_VAR (this_object);
  if ((ret = thrift_protocol_write_struct_begin (protocol, "CalculatorGetLogType1Args", error)) < 0)
    return -1;
  xfer += ret;
  if ((ret = thrift_protocol_write_field_stop (protocol, error)) < 0)
    return -1;
...
static void 
calculator_get_log_type1_args_instance_init (CalculatorGetLogType1Args * object)
{
  /* satisfy -Wall */
  THRIFT_UNUSED_VAR (object);
}
...
static void 
calculator_get_log_type1_args_finalize (GObject *object)
{
  CalculatorGetLogType1Args *tobject = CALCULATOR_GET_LOG_TYPE1_ARGS (object);
...
static void
calculator_get_log_type1_args_class_init (CalculatorGetLogType1ArgsClass * cls)
{
  GObjectClass *gobject_class = G_OBJECT_CLASS (cls);
  ThriftStructClass *struct_class = THRIFT_STRUCT_CLASS (cls);

  struct_class->read = calculator_get_log_type1_args_read;
  struct_class->write = calculator_get_log_type1_args_write;

  gobject_class->finalize = calculator_get_log_type1_args_finalize;
}

GType
calculator_get_log_type1_args_get_type (void)
{
  static GType type = 0;
  ...
  if (type == 0) 
  {
    static const GTypeInfo type_info = 
    {
      sizeof (CalculatorGetLogType1ArgsClass),
      NULL, /* base_init */
      NULL, /* base_finalize */
      (GClassInitFunc) calculator_get_log_type1_args_class_init,
      NULL, /* class_finalize */
      NULL, /* class_data */
      sizeof (CalculatorGetLogType1Args),
      0, /* n_preallocs */
      (GInstanceInitFunc) calculator_get_log_type1_args_instance_init,
      NULL, /* value_table */
    };

    type = g_type_register_static (THRIFT_TYPE_STRUCT, 
                                   "CalculatorGetLogType1ArgsType",
                                   &type_info, 0);
  }
...
enum _CalculatorGetLogType1ResultProperties
{
  PROP_CALCULATOR_GET_LOG_TYPE1_RESULT_0,
  PROP_CALCULATOR_GET_LOG_TYPE1_RESULT_SUCCESS
};

/* reads a calculator_get_log_type1_result object */
static gint32
calculator_get_log_type1_result_read (ThriftStruct *object, ThriftProtocol *protocol, GError **error)
{
  gint32 ret;
  gint32 xfer = 0;
  gchar *name = NULL;
  ...
  guint32 len = 0;
  gpointer data = NULL;
  CalculatorGetLogType1Result * this_object = CALCULATOR_GET_LOG_TYPE1_RESULT(object);
...
static gint32
calculator_get_log_type1_result_write (ThriftStruct *object, ThriftProtocol *protocol, GError **error)
{
  gint32 ret;
  gint32 xfer = 0;
  ...
  CalculatorGetLogType1Result * this_object = CALCULATOR_GET_LOG_TYPE1_RESULT(object);
  THRIFT_UNUSED_VAR (this_object);
  if ((ret = thrift_protocol_write_struct_begin (protocol, "CalculatorGetLogType1Result", error)) < 0)
    return -1;
  xfer += ret;
...
static void
calculator_get_log_type1_result_set_property (GObject *object,
                                              guint property_id,
                                              const GValue *value,
                                              GParamSpec *pspec)
{
  CalculatorGetLogType1Result *self = CALCULATOR_GET_LOG_TYPE1_RESULT (object);

  switch (property_id)
  {
    case PROP_CALCULATOR_GET_LOG_TYPE1_RESULT_SUCCESS:
...
static void
calculator_get_log_type1_result_get_property (GObject *object,
                                              guint property_id,
                                              GValue *value,
                                              GParamSpec *pspec)
{
...
static void 
calculator_get_log_type1_result_instance_init (CalculatorGetLogType1Result * object)
{
  /* satisfy -Wall */
  THRIFT_UNUSED_VAR (object);
  object->success = 0;
...
static void 
calculator_get_log_type1_result_finalize (GObject *object)
{
  CalculatorGetLogType1Result *tobject = CALCULATOR_GET_LOG_TYPE1_RESULT (object);
...
static void
calculator_get_log_type1_result_class_init (CalculatorGetLogType1ResultClass * cls)
{
  GObjectClass *gobject_class = G_OBJECT_CLASS (cls);
  ThriftStructClass *struct_class = THRIFT_STRUCT_CLASS (cls);

  struct_class->read = calculator_get_log_type1_result_read;
  struct_class->write = calculator_get_log_type1_result_write;

  gobject_class->finalize = calculator_get_log_type1_result_finalize;
  gobject_class->get_property = calculator_get_log_type1_result_get_property;
  gobject_class->set_property = calculator_get_log_type1_result_set_property;
...
GType
calculator_get_log_type1_result_get_type (void)
{
  static GType type = 0;
  ...
  if (type == 0) 
  {
    static const GTypeInfo type_info = 
    {
      sizeof (CalculatorGetLogType1ResultClass),
      NULL, /* base_init */
      NULL, /* base_finalize */
      (GClassInitFunc) calculator_get_log_type1_result_class_init,
      NULL, /* class_finalize */
      NULL, /* class_data */
      sizeof (CalculatorGetLogType1Result),
      0, /* n_preallocs */
      (GInstanceInitFunc) calculator_get_log_type1_result_instance_init,
      NULL, /* value_table */
    };

    type = g_type_register_static (THRIFT_TYPE_STRUCT, 
                                   "CalculatorGetLogType1ResultType",
                                   &type_info, 0);
  }
...
enum _CalculatorSetLogType1ArgsProperties
{
  PROP_CALCULATOR_SET_LOG_TYPE1_ARGS_0,
  PROP_CALCULATOR_SET_LOG_TYPE1_ARGS_LOG_TYPE1
};

/* reads a calculator_set_log_type1_args object */
static gint32
calculator_set_log_type1_args_read (ThriftStruct *object, ThriftProtocol *protocol, GError **error)
{
  gint32 ret;
  gint32 xfer = 0;
  gchar *name = NULL;
  ...
  guint32 len = 0;
  gpointer data = NULL;
  CalculatorSetLogType1Args * this_object = CALCULATOR_SET_LOG_TYPE1_ARGS(object);
  ...
  while (1)
  {
    ...
    switch (fid)
    {
      case 1:
        if (ftype == T_I32)
        {
          if ((ret = thrift_protocol_read_i32 (protocol, &this_object->logType1, error)) < 0)
            return -1;
          xfer += ret;
          this_object->__isset_logType1 = TRUE;
        } else {
          if ((ret = thrift_protocol_skip (protocol, ftype, error)) < 0)
            return -1;
          xfer += ret;
...
static gint32
calculator_set_log_type1_args_write (ThriftStruct *object, ThriftProtocol *protocol, GError **error)
{
  gint32 ret;
  gint32 xfer = 0;
  ...
  CalculatorSetLogType1Args * this_object = CALCULATOR_SET_LOG_TYPE1_ARGS(object);
  THRIFT_UNUSED_VAR (this_object);
  if ((ret = thrift_protocol_write_struct_begin (protocol, "CalculatorSetLogType1Args", error)) < 0)
    return -1;
  xfer += ret;
  if ((ret = thrift_protocol_write_field_begin (protocol, "logType1", T_I32, 1, error)) < 0)
    return -1;
  xfer += ret;
  if ((ret = thrift_protocol_write_i32 (protocol, this_object->logType1, error)) < 0)
    return -1;
  xfer += ret;
...
static void
calculator_set_log_type1_args_set_property (GObject *object,
                                            guint property_id,
                                            const GValue *value,
                                            GParamSpec *pspec)
{
  CalculatorSetLogType1Args *self = CALCULATOR_SET_LOG_TYPE1_ARGS (object);

  switch (property_id)
  {
    case PROP_CALCULATOR_SET_LOG_TYPE1_ARGS_LOG_TYPE1:
      self->logType1 = g_value_get_int (value);
      self->__isset_logType1 = TRUE;
      break;
...
static void
calculator_set_log_type1_args_get_property (GObject *object,
                                            guint property_id,
                                            GValue *value,
                                            GParamSpec *pspec)
{
  ...
  {
    case PROP_CALCULATOR_SET_LOG_TYPE1_ARGS_LOG_TYPE1:
      g_value_set_int (value, self->logType1);
      break;
...
static void 
calculator_set_log_type1_args_instance_init (CalculatorSetLogType1Args * object)
{
  /* satisfy -Wall */
  THRIFT_UNUSED_VAR (object);
  object->logType1 = 0;
  object->__isset_logType1 = FALSE;
}

static void 
calculator_set_log_type1_args_finalize (GObject *object)
{
  CalculatorSetLogType1Args *tobject = CALCULATOR_SET_LOG_TYPE1_ARGS (object);
...
static void
calculator_set_log_type1_args_class_init (CalculatorSetLogType1ArgsClass * cls)
{
  GObjectClass *gobject_class = G_OBJECT_CLASS (cls);
  ThriftStructClass *struct_class = THRIFT_STRUCT_CLASS (cls);

  struct_class->read = calculator_set_log_type1_args_read;
  struct_class->write = calculator_set_log_type1_args_write;

  gobject_class->finalize = calculator_set_log_type1_args_finalize;
  gobject_class->get_property = calculator_set_log_type1_args_get_property;
  gobject_class->set_property = calculator_set_log_type1_args_set_property;

  g_object_class_install_property
    (gobject_class,
     PROP_CALCULATOR_SET_LOG_TYPE1_ARGS_LOG_TYPE1,
     g_param_spec_int ("logType1",
                       NULL,
                       NULL,
                       G_MININT32,
                       G_MAXINT32,
...
GType
calculator_set_log_type1_args_get_type (void)
{
  static GType type = 0;
  ...
  if (type == 0) 
  {
    static const GTypeInfo type_info = 
    {
      sizeof (CalculatorSetLogType1ArgsClass),
      NULL, /* base_init */
      NULL, /* base_finalize */
      (GClassInitFunc) calculator_set_log_type1_args_class_init,
      NULL, /* class_finalize */
      NULL, /* class_data */
      sizeof (CalculatorSetLogType1Args),
      0, /* n_preallocs */
      (GInstanceInitFunc) calculator_set_log_type1_args_instance_init,
      NULL, /* value_table */
    };

    type = g_type_register_static (THRIFT_TYPE_STRUCT, 
                                   "CalculatorSetLogType1ArgsType",
                                   &type_info, 0);
  }
...
enum _CalculatorSetLogType1ResultProperties
{
  PROP_CALCULATOR_SET_LOG_TYPE1_RESULT_0,
  PROP_CALCULATOR_SET_LOG_TYPE1_RESULT_SUCCESS
};

/* reads a calculator_set_log_type1_result object */
static gint32
calculator_set_log_type1_result_read (ThriftStruct *object, ThriftProtocol *protocol, GError **error)
{
  gint32 ret;
  gint32 xfer = 0;
  gchar *name = NULL;
  ...
  guint32 len = 0;
  gpointer data = NULL;
  CalculatorSetLogType1Result * this_object = CALCULATOR_SET_LOG_TYPE1_RESULT(object);
...
static gint32
calculator_set_log_type1_result_write (ThriftStruct *object, ThriftProtocol *protocol, GError **error)
{
  gint32 ret;
  gint32 xfer = 0;
  ...
  CalculatorSetLogType1Result * this_object = CALCULATOR_SET_LOG_TYPE1_RESULT(object);
  THRIFT_UNUSED_VAR (this_object);
  if ((ret = thrift_protocol_write_struct_begin (protocol, "CalculatorSetLogType1Result", error)) < 0)
    return -1;
  xfer += ret;
  if (this_object->__isset_success == TRUE) {
    if ((ret = thrift_protocol_write_field_begin (protocol, "success", T_I32, 0, error)) < 0)
...
static void
calculator_set_log_type1_result_set_property (GObject *object,
                                              guint property_id,
                                              const GValue *value,
                                              GParamSpec *pspec)
{
  CalculatorSetLogType1Result *self = CALCULATOR_SET_LOG_TYPE1_RESULT (object);

  switch (property_id)
  {
    case PROP_CALCULATOR_SET_LOG_TYPE1_RESULT_SUCCESS:
      self->success = g_value_get_int (value);
      self->__isset_success = TRUE;
      break;
...
static void
calculator_set_log_type1_result_get_property (GObject *object,
                                              guint property_id,
                                              GValue *value,
                                              GParamSpec *pspec)
{
...
static void 
calculator_set_log_type1_result_instance_init (CalculatorSetLogType1Result * object)
{
  /* satisfy -Wall */
  THRIFT_UNUSED_VAR (object);
  object->success = 0;
...
static void 
calculator_set_log_type1_result_finalize (GObject *object)
{
  CalculatorSetLogType1Result *tobject = CALCULATOR_SET_LOG_TYPE1_RESULT (object);
...
static void
calculator_set_log_type1_result_class_init (CalculatorSetLogType1ResultClass * cls)
{
  GObjectClass *gobject_class = G_OBJECT_CLASS (cls);
  ThriftStructClass *struct_class = THRIFT_STRUCT_CLASS (cls);

  struct_class->read = calculator_set_log_type1_result_read;
  struct_class->write = calculator_set_log_type1_result_write;

  gobject_class->finalize = calculator_set_log_type1_result_finalize;
  gobject_class->get_property = calculator_set_log_type1_result_get_property;
  gobject_class->set_property = calculator_set_log_type1_result_set_property;
...
GType
calculator_set_log_type1_result_get_type (void)
{
  static GType type = 0;
  ...
  if (type == 0) 
  {
    static const GTypeInfo type_info = 
    {
      sizeof (CalculatorSetLogType1ResultClass),
      NULL, /* base_init */
      NULL, /* base_finalize */
      (GClassInitFunc) calculator_set_log_type1_result_class_init,
      NULL, /* class_finalize */
      NULL, /* class_data */
      sizeof (CalculatorSetLogType1Result),
      0, /* n_preallocs */
      (GInstanceInitFunc) calculator_set_log_type1_result_instance_init,
      NULL, /* value_table */
    };

    type = g_type_register_static (THRIFT_TYPE_STRUCT, 
                                   "CalculatorSetLogType1ResultType",
                                   &type_info, 0);
  }
...
enum _CalculatorSetTestReportArgsProperties
{
  PROP_CALCULATOR_SET_TEST_REPORT_ARGS_0,
  PROP_CALCULATOR_SET_TEST_REPORT_ARGS_REPORT_TIME
};

/* reads a calculator_set_test_report_args object */
static gint32
calculator_set_test_report_args_read (ThriftStruct *object, ThriftProtocol *protocol, GError **error)
{
  gint32 ret;
  gint32 xfer = 0;
  gchar *name = NULL;
  ...
  guint32 len = 0;
  gpointer data = NULL;
  CalculatorSetTestReportArgs * this_object = CALCULATOR_SET_TEST_REPORT_ARGS(object);
  ...
  while (1)
  {
    ...
    switch (fid)
    {
      case 1:
        if (ftype == T_I32)
        {
          if ((ret = thrift_protocol_read_i32 (protocol, &this_object->ReportTime, error)) < 0)
            return -1;
          xfer += ret;
          this_object->__isset_ReportTime = TRUE;
        } else {
          if ((ret = thrift_protocol_skip (protocol, ftype, error)) < 0)
            return -1;
          xfer += ret;
...
static gint32
calculator_set_test_report_args_write (ThriftStruct *object, ThriftProtocol *protocol, GError **error)
{
  gint32 ret;
  gint32 xfer = 0;
  ...
  CalculatorSetTestReportArgs * this_object = CALCULATOR_SET_TEST_REPORT_ARGS(object);
  THRIFT_UNUSED_VAR (this_object);
  if ((ret = thrift_protocol_write_struct_begin (protocol, "CalculatorSetTestReportArgs", error)) < 0)
    return -1;
  xfer += ret;
  if ((ret = thrift_protocol_write_field_begin (protocol, "ReportTime", T_I32, 1, error)) < 0)
    return -1;
  xfer += ret;
  if ((ret = thrift_protocol_write_i32 (protocol, this_object->ReportTime, error)) < 0)
    return -1;
  xfer += ret;
...
static void
calculator_set_test_report_args_set_property (GObject *object,
                                              guint property_id,
                                              const GValue *value,
                                              GParamSpec *pspec)
{
  CalculatorSetTestReportArgs *self = CALCULATOR_SET_TEST_REPORT_ARGS (object);

  switch (property_id)
  {
    case PROP_CALCULATOR_SET_TEST_REPORT_ARGS_REPORT_TIME:
      self->ReportTime = g_value_get_int (value);
      self->__isset_ReportTime = TRUE;
      break;
...
static void
calculator_set_test_report_args_get_property (GObject *object,
                                              guint property_id,
                                              GValue *value,
                                              GParamSpec *pspec)
{
  ...
  {
    case PROP_CALCULATOR_SET_TEST_REPORT_ARGS_REPORT_TIME:
      g_value_set_int (value, self->ReportTime);
      break;
...
static void 
calculator_set_test_report_args_instance_init (CalculatorSetTestReportArgs * object)
{
  /* satisfy -Wall */
  THRIFT_UNUSED_VAR (object);
  object->ReportTime = 0;
  object->__isset_ReportTime = FALSE;
}

static void 
calculator_set_test_report_args_finalize (GObject *object)
{
  CalculatorSetTestReportArgs *tobject = CALCULATOR_SET_TEST_REPORT_ARGS (object);
...
static void
calculator_set_test_report_args_class_init (CalculatorSetTestReportArgsClass * cls)
{
  GObjectClass *gobject_class = G_OBJECT_CLASS (cls);
  ThriftStructClass *struct_class = THRIFT_STRUCT_CLASS (cls);

  struct_class->read = calculator_set_test_report_args_read;
  struct_class->write = calculator_set_test_report_args_write;

  gobject_class->finalize = calculator_set_test_report_args_finalize;
  gobject_class->get_property = calculator_set_test_report_args_get_property;
  gobject_class->set_property = calculator_set_test_report_args_set_property;

  g_object_class_install_property
    (gobject_class,
     PROP_CALCULATOR_SET_TEST_REPORT_ARGS_REPORT_TIME,
     g_param_spec_int ("ReportTime",
                       NULL,
                       NULL,
                       G_MININT32,
                       G_MAXINT32,
...
GType
calculator_set_test_report_args_get_type (void)
{
  static GType type = 0;
  ...
  if (type == 0) 
  {
    static const GTypeInfo type_info = 
    {
      sizeof (CalculatorSetTestReportArgsClass),
      NULL, /* base_init */
      NULL, /* base_finalize */
      (GClassInitFunc) calculator_set_test_report_args_class_init,
      NULL, /* class_finalize */
      NULL, /* class_data */
      sizeof (CalculatorSetTestReportArgs),
      0, /* n_preallocs */
      (GInstanceInitFunc) calculator_set_test_report_args_instance_init,
      NULL, /* value_table */
    };

    type = g_type_register_static (THRIFT_TYPE_STRUCT, 
                                   "CalculatorSetTestReportArgsType",
                                   &type_info, 0);
  }
...
enum _CalculatorSetTestReportResultProperties
{
  PROP_CALCULATOR_SET_TEST_REPORT_RESULT_0,
  PROP_CALCULATOR_SET_TEST_REPORT_RESULT_SUCCESS
};

/* reads a calculator_set_test_report_result object */
static gint32
calculator_set_test_report_result_read (ThriftStruct *object, ThriftProtocol *protocol, GError **error)
{
  gint32 ret;
  gint32 xfer = 0;
  gchar *name = NULL;
  ...
  guint32 len = 0;
  gpointer data = NULL;
  CalculatorSetTestReportResult * this_object = CALCULATOR_SET_TEST_REPORT_RESULT(object);
...
static gint32
calculator_set_test_report_result_write (ThriftStruct *object, ThriftProtocol *protocol, GError **error)
{
  gint32 ret;
  gint32 xfer = 0;
  ...
  CalculatorSetTestReportResult * this_object = CALCULATOR_SET_TEST_REPORT_RESULT(object);
  THRIFT_UNUSED_VAR (this_object);
  if ((ret = thrift_protocol_write_struct_begin (protocol, "CalculatorSetTestReportResult", error)) < 0)
    return -1;
  xfer += ret;
  if (this_object->__isset_success == TRUE) {
    if ((ret = thrift_protocol_write_field_begin (protocol, "success", T_I32, 0, error)) < 0)
...
static void
calculator_set_test_report_result_set_property (GObject *object,
                                                guint property_id,
                                                const GValue *value,
                                                GParamSpec *pspec)
{
  CalculatorSetTestReportResult *self = CALCULATOR_SET_TEST_REPORT_RESULT (object);

  switch (property_id)
  {
    case PROP_CALCULATOR_SET_TEST_REPORT_RESULT_SUCCESS:
      self->success = g_value_get_int (value);
      self->__isset_success = TRUE;
      break;
...
static void
calculator_set_test_report_result_get_property (GObject *object,
                                                guint property_id,
                                                GValue *value,
                                                GParamSpec *pspec)
{
...
static void 
calculator_set_test_report_result_instance_init (CalculatorSetTestReportResult * object)
{
  /* satisfy -Wall */
  THRIFT_UNUSED_VAR (object);
  object->success = 0;
...
static void 
calculator_set_test_report_result_finalize (GObject *object)
{
  CalculatorSetTestReportResult *tobject = CALCULATOR_SET_TEST_REPORT_RESULT (object);
...
static void
calculator_set_test_report_result_class_init (CalculatorSetTestReportResultClass * cls)
{
  GObjectClass *gobject_class = G_OBJECT_CLASS (cls);
  ThriftStructClass *struct_class = THRIFT_STRUCT_CLASS (cls);

  struct_class->read = calculator_set_test_report_result_read;
  struct_class->write = calculator_set_test_report_result_write;

  gobject_class->finalize = calculator_set_test_report_result_finalize;
  gobject_class->get_property = calculator_set_test_report_result_get_property;
  gobject_class->set_property = calculator_set_test_report_result_set_property;
...
GType
calculator_set_test_report_result_get_type (void)
{
  static GType type = 0;
  ...
  if (type == 0) 
  {
    static const GTypeInfo type_info = 
    {
      sizeof (CalculatorSetTestReportResultClass),
      NULL, /* base_init */
      NULL, /* base_finalize */
      (GClassInitFunc) calculator_set_test_report_result_class_init,
      NULL, /* class_finalize */
      NULL, /* class_data */
      sizeof (CalculatorSetTestReportResult),
      0, /* n_preallocs */
      (GInstanceInitFunc) calculator_set_test_report_result_instance_init,
      NULL, /* value_table */
    };

    type = g_type_register_static (THRIFT_TYPE_STRUCT, 
                                   "CalculatorSetTestReportResultType",
                                   &type_info, 0);
  }
...
/* reads a calculator_get_test_report_args object */
static gint32
calculator_get_test_report_args_read (ThriftStruct *object, ThriftProtocol *protocol, GError **error)
{
  gint32 ret;
  gint32 xfer = 0;
  gchar *name = NULL;
  ...
  guint32 len = 0;
  gpointer data = NULL;
  CalculatorGetTestReportArgs * this_object = CALCULATOR_GET_TEST_REPORT_ARGS(object);
...
static gint32
calculator_get_test_report_args_write (ThriftStruct *object, ThriftProtocol *protocol, GError **error)
{
  gint32 ret;
  gint32 xfer = 0;
  ...
  CalculatorGetTestReportArgs * this_object = CALCULATOR_GET_TEST_REPORT_ARGS(object);
  THRIFT_UNUSED_VAR (this_object);
  if ((ret = thrift_protocol_write_struct_begin (protocol, "CalculatorGetTestReportArgs", error)) < 0)
    return -1;
  xfer += ret;
  if ((ret = thrift_protocol_write_field_stop (protocol, error)) < 0)
    return -1;
...
static void 
calculator_get_test_report_args_instance_init (CalculatorGetTestReportArgs * object)
{
  /* satisfy -Wall */
  THRIFT_UNUSED_VAR (object);
}
...
static void 
calculator_get_test_report_args_finalize (GObject *object)
{
  CalculatorGetTestReportArgs *tobject = CALCULATOR_GET_TEST_REPORT_ARGS (object);
...
static void
calculator_get_test_report_args_class_init (CalculatorGetTestReportArgsClass * cls)
{
  GObjectClass *gobject_class = G_OBJECT_CLASS (cls);
  ThriftStructClass *struct_class = THRIFT_STRUCT_CLASS (cls);

  struct_class->read = calculator_get_test_report_args_read;
  struct_class->write = calculator_get_test_report_args_write;

  gobject_class->finalize = calculator_get_test_report_args_finalize;
}

GType
calculator_get_test_report_args_get_type (void)
{
  static GType type = 0;
  ...
  if (type == 0) 
  {
    static const GTypeInfo type_info = 
    {
      sizeof (CalculatorGetTestReportArgsClass),
      NULL, /* base_init */
      NULL, /* base_finalize */
      (GClassInitFunc) calculator_get_test_report_args_class_init,
      NULL, /* class_finalize */
      NULL, /* class_data */
      sizeof (CalculatorGetTestReportArgs),
      0, /* n_preallocs */
      (GInstanceInitFunc) calculator_get_test_report_args_instance_init,
      NULL, /* value_table */
    };

    type = g_type_register_static (THRIFT_TYPE_STRUCT, 
                                   "CalculatorGetTestReportArgsType",
                                   &type_info, 0);
  }
...
enum _CalculatorGetTestReportResultProperties
{
  PROP_CALCULATOR_GET_TEST_REPORT_RESULT_0,
  PROP_CALCULATOR_GET_TEST_REPORT_RESULT_SUCCESS
};

/* reads a calculator_get_test_report_result object */
static gint32
calculator_get_test_report_result_read (ThriftStruct *object, ThriftProtocol *protocol, GError **error)
{
  gint32 ret;
  gint32 xfer = 0;
  gchar *name = NULL;
  ...
  guint32 len = 0;
  gpointer data = NULL;
  CalculatorGetTestReportResult * this_object = CALCULATOR_GET_TEST_REPORT_RESULT(object);
...
static gint32
calculator_get_test_report_result_write (ThriftStruct *object, ThriftProtocol *protocol, GError **error)
{
  gint32 ret;
  gint32 xfer = 0;
  ...
  CalculatorGetTestReportResult * this_object = CALCULATOR_GET_TEST_REPORT_RESULT(object);
  THRIFT_UNUSED_VAR (this_object);
  if ((ret = thrift_protocol_write_struct_begin (protocol, "CalculatorGetTestReportResult", error)) < 0)
    return -1;
  xfer += ret;
  if (this_object->__isset_success == TRUE) {
    if ((ret = thrift_protocol_write_field_begin (protocol, "success", T_I32, 0, error)) < 0)
...
static void
calculator_get_test_report_result_set_property (GObject *object,
                                                guint property_id,
                                                const GValue *value,
                                                GParamSpec *pspec)
{
  CalculatorGetTestReportResult *self = CALCULATOR_GET_TEST_REPORT_RESULT (object);

  switch (property_id)
  {
    case PROP_CALCULATOR_GET_TEST_REPORT_RESULT_SUCCESS:
      self->success = g_value_get_int (value);
      self->__isset_success = TRUE;
      break;
...
static void
calculator_get_test_report_result_get_property (GObject *object,
                                                guint property_id,
                                                GValue *value,
                                                GParamSpec *pspec)
{
...
static void 
calculator_get_test_report_result_instance_init (CalculatorGetTestReportResult * object)
{
  /* satisfy -Wall */
  THRIFT_UNUSED_VAR (object);
  object->success = 0;
...
static void 
calculator_get_test_report_result_finalize (GObject *object)
{
  CalculatorGetTestReportResult *tobject = CALCULATOR_GET_TEST_REPORT_RESULT (object);
...
static void
calculator_get_test_report_result_class_init (CalculatorGetTestReportResultClass * cls)
{
  GObjectClass *gobject_class = G_OBJECT_CLASS (cls);
  ThriftStructClass *struct_class = THRIFT_STRUCT_CLASS (cls);

  struct_class->read = calculator_get_test_report_result_read;
  struct_class->write = calculator_get_test_report_result_write;

  gobject_class->finalize = calculator_get_test_report_result_finalize;
  gobject_class->get_property = calculator_get_test_report_result_get_property;
  gobject_class->set_property = calculator_get_test_report_result_set_property;
...
GType
calculator_get_test_report_result_get_type (void)
{
  static GType type = 0;
  ...
  if (type == 0) 
  {
    static const GTypeInfo type_info = 
    {
      sizeof (CalculatorGetTestReportResultClass),
      NULL, /* base_init */
      NULL, /* base_finalize */
      (GClassInitFunc) calculator_get_test_report_result_class_init,
      NULL, /* class_finalize */
      NULL, /* class_data */
      sizeof (CalculatorGetTestReportResult),
      0, /* n_preallocs */
      (GInstanceInitFunc) calculator_get_test_report_result_instance_init,
      NULL, /* value_table */
    };

    type = g_type_register_static (THRIFT_TYPE_STRUCT, 
                                   "CalculatorGetTestReportResultType",
                                   &type_info, 0);
  }
