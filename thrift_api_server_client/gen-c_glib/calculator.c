...
gboolean
calculator_if_get_log_type1 (CalculatorIf *iface, gint32* _return, GError **error)
{
  return CALCULATOR_IF_GET_INTERFACE (iface)->get_log_type1 (iface, _return, error);
}

gboolean
calculator_if_set_log_type1 (CalculatorIf *iface, gint32* _return, const gint32 logType1, GError **error)
{
  return CALCULATOR_IF_GET_INTERFACE (iface)->set_log_type1 (iface, _return, logType1, error);
}

gboolean
calculator_if_set_test_report (CalculatorIf *iface, gint32* _return, const gint32 ReportTime, GError **error)
{
  return CALCULATOR_IF_GET_INTERFACE (iface)->set_test_report (iface, _return, ReportTime, error);
}

gboolean
calculator_if_get_test_report (CalculatorIf *iface, gint32* _return, GError **error)
{
  return CALCULATOR_IF_GET_INTERFACE (iface)->get_test_report (iface, _return, error);
}
...
gboolean calculator_client_send_get_log_type1 (CalculatorIf * iface, GError ** error)
{
  gint32 cseqid = 0;
  ThriftProtocol * protocol = SHARED_SERVICE_CLIENT (iface)->output_protocol;

  if (thrift_protocol_write_message_begin (protocol, "getLogType1", T_CALL, cseqid, error) < 0)
    return FALSE;

  {
    ...
    if ((ret = thrift_protocol_write_struct_begin (protocol, "getLogType1_args", error)) < 0)
      return 0;
    xfer += ret;
    if ((ret = thrift_protocol_write_field_stop (protocol, error)) < 0)
      return 0;
...
gboolean calculator_client_recv_get_log_type1 (CalculatorIf * iface, gint32* _return, GError ** error)
{
  gint32 rseqid;
  gchar * fname = NULL;
  ThriftMessageType mtype;
  ...
  if (mtype == T_EXCEPTION) {
    ...
    g_set_error (error, THRIFT_APPLICATION_EXCEPTION_ERROR, THRIFT_APPLICATION_EXCEPTION_ERROR_INVALID_MESSAGE_TYPE, "invalid message type %d, expected T_REPLY", mtype);
    return FALSE;
  } else if (strncmp (fname, "getLogType1", 11) != 0) {
    thrift_protocol_skip (protocol, T_STRUCT, NULL);
    thrift_protocol_read_message_end (protocol,error);
    thrift_transport_read_end (protocol->transport, error);
    g_set_error (error, THRIFT_APPLICATION_EXCEPTION_ERROR, THRIFT_APPLICATION_EXCEPTION_ERROR_WRONG_METHOD_NAME, "wrong method name %s, expected getLogType1", fname);
    if (fname) g_free (fname);
    return FALSE;
  }
  if (fname) g_free (fname);
...
gboolean calculator_client_get_log_type1 (CalculatorIf * iface, gint32* _return, GError ** error)
{
  if (!calculator_client_send_get_log_type1 (iface, error))
    return FALSE;
  if (!calculator_client_recv_get_log_type1 (iface, _return, error))
    return FALSE;
  return TRUE;
}

gboolean calculator_client_send_set_log_type1 (CalculatorIf * iface, const gint32 logType1, GError ** error)
{
  gint32 cseqid = 0;
  ThriftProtocol * protocol = SHARED_SERVICE_CLIENT (iface)->output_protocol;

  if (thrift_protocol_write_message_begin (protocol, "setLogType1", T_CALL, cseqid, error) < 0)
    return FALSE;

  {
    ...
    if ((ret = thrift_protocol_write_struct_begin (protocol, "setLogType1_args", error)) < 0)
      return 0;
    xfer += ret;
    if ((ret = thrift_protocol_write_field_begin (protocol, "logType1", T_I32, 1, error)) < 0)
      return 0;
    xfer += ret;
    if ((ret = thrift_protocol_write_i32 (protocol, logType1, error)) < 0)
      return 0;
    xfer += ret;
...
gboolean calculator_client_recv_set_log_type1 (CalculatorIf * iface, gint32* _return, GError ** error)
{
  gint32 rseqid;
  gchar * fname = NULL;
  ThriftMessageType mtype;
  ...
  if (mtype == T_EXCEPTION) {
    ...
    g_set_error (error, THRIFT_APPLICATION_EXCEPTION_ERROR, THRIFT_APPLICATION_EXCEPTION_ERROR_INVALID_MESSAGE_TYPE, "invalid message type %d, expected T_REPLY", mtype);
    return FALSE;
  } else if (strncmp (fname, "setLogType1", 11) != 0) {
    thrift_protocol_skip (protocol, T_STRUCT, NULL);
    thrift_protocol_read_message_end (protocol,error);
    thrift_transport_read_end (protocol->transport, error);
    g_set_error (error, THRIFT_APPLICATION_EXCEPTION_ERROR, THRIFT_APPLICATION_EXCEPTION_ERROR_WRONG_METHOD_NAME, "wrong method name %s, expected setLogType1", fname);
    if (fname) g_free (fname);
    return FALSE;
  }
  if (fname) g_free (fname);
...
gboolean calculator_client_set_log_type1 (CalculatorIf * iface, gint32* _return, const gint32 logType1, GError ** error)
{
  if (!calculator_client_send_set_log_type1 (iface, logType1, error))
    return FALSE;
  if (!calculator_client_recv_set_log_type1 (iface, _return, error))
    return FALSE;
  return TRUE;
}

gboolean calculator_client_send_set_test_report (CalculatorIf * iface, const gint32 ReportTime, GError ** error)
{
  gint32 cseqid = 0;
  ThriftProtocol * protocol = SHARED_SERVICE_CLIENT (iface)->output_protocol;

  if (thrift_protocol_write_message_begin (protocol, "setTestReport", T_CALL, cseqid, error) < 0)
    return FALSE;

  {
    ...
    if ((ret = thrift_protocol_write_struct_begin (protocol, "setTestReport_args", error)) < 0)
      return 0;
    xfer += ret;
    if ((ret = thrift_protocol_write_field_begin (protocol, "ReportTime", T_I32, 1, error)) < 0)
      return 0;
    xfer += ret;
    if ((ret = thrift_protocol_write_i32 (protocol, ReportTime, error)) < 0)
      return 0;
    xfer += ret;
...
gboolean calculator_client_recv_set_test_report (CalculatorIf * iface, gint32* _return, GError ** error)
{
  gint32 rseqid;
  gchar * fname = NULL;
  ThriftMessageType mtype;
  ...
  if (mtype == T_EXCEPTION) {
    ...
    g_set_error (error, THRIFT_APPLICATION_EXCEPTION_ERROR, THRIFT_APPLICATION_EXCEPTION_ERROR_INVALID_MESSAGE_TYPE, "invalid message type %d, expected T_REPLY", mtype);
    return FALSE;
  } else if (strncmp (fname, "setTestReport", 13) != 0) {
    thrift_protocol_skip (protocol, T_STRUCT, NULL);
    thrift_protocol_read_message_end (protocol,error);
    thrift_transport_read_end (protocol->transport, error);
    g_set_error (error, THRIFT_APPLICATION_EXCEPTION_ERROR, THRIFT_APPLICATION_EXCEPTION_ERROR_WRONG_METHOD_NAME, "wrong method name %s, expected setTestReport", fname);
    if (fname) g_free (fname);
    return FALSE;
  }
  if (fname) g_free (fname);
...
gboolean calculator_client_set_test_report (CalculatorIf * iface, gint32* _return, const gint32 ReportTime, GError ** error)
{
  if (!calculator_client_send_set_test_report (iface, ReportTime, error))
    return FALSE;
  if (!calculator_client_recv_set_test_report (iface, _return, error))
    return FALSE;
  return TRUE;
}

gboolean calculator_client_send_get_test_report (CalculatorIf * iface, GError ** error)
{
  gint32 cseqid = 0;
  ThriftProtocol * protocol = SHARED_SERVICE_CLIENT (iface)->output_protocol;

  if (thrift_protocol_write_message_begin (protocol, "getTestReport", T_CALL, cseqid, error) < 0)
    return FALSE;

  {
    ...
    if ((ret = thrift_protocol_write_struct_begin (protocol, "getTestReport_args", error)) < 0)
      return 0;
    xfer += ret;
    if ((ret = thrift_protocol_write_field_stop (protocol, error)) < 0)
      return 0;
...
gboolean calculator_client_recv_get_test_report (CalculatorIf * iface, gint32* _return, GError ** error)
{
  gint32 rseqid;
  gchar * fname = NULL;
  ThriftMessageType mtype;
  ...
  if (mtype == T_EXCEPTION) {
    ...
    g_set_error (error, THRIFT_APPLICATION_EXCEPTION_ERROR, THRIFT_APPLICATION_EXCEPTION_ERROR_INVALID_MESSAGE_TYPE, "invalid message type %d, expected T_REPLY", mtype);
    return FALSE;
  } else if (strncmp (fname, "getTestReport", 13) != 0) {
    thrift_protocol_skip (protocol, T_STRUCT, NULL);
    thrift_protocol_read_message_end (protocol,error);
    thrift_transport_read_end (protocol->transport, error);
    g_set_error (error, THRIFT_APPLICATION_EXCEPTION_ERROR, THRIFT_APPLICATION_EXCEPTION_ERROR_WRONG_METHOD_NAME, "wrong method name %s, expected getTestReport", fname);
    if (fname) g_free (fname);
    return FALSE;
  }
  if (fname) g_free (fname);
...
gboolean calculator_client_get_test_report (CalculatorIf * iface, gint32* _return, GError ** error)
{
  if (!calculator_client_send_get_test_report (iface, error))
    return FALSE;
  if (!calculator_client_recv_get_test_report (iface, _return, error))
    return FALSE;
  return TRUE;
}
...
calculator_if_interface_init (CalculatorIfInterface *iface)
{
  ...
  iface->get_log_type1 = calculator_client_get_log_type1;
  iface->set_log_type1 = calculator_client_set_log_type1;
  iface->set_test_report = calculator_client_set_test_report;
  iface->get_test_report = calculator_client_get_test_report;
...
gboolean calculator_handler_get_log_type1 (CalculatorIf * iface, gint32* _return, GError ** error)
{
  g_return_val_if_fail (IS_CALCULATOR_HANDLER (iface), FALSE);

  return CALCULATOR_HANDLER_GET_CLASS (iface)->get_log_type1 (iface, _return, error);
}

gboolean calculator_handler_set_log_type1 (CalculatorIf * iface, gint32* _return, const gint32 logType1, GError ** error)
{
  g_return_val_if_fail (IS_CALCULATOR_HANDLER (iface), FALSE);

  return CALCULATOR_HANDLER_GET_CLASS (iface)->set_log_type1 (iface, _return, logType1, error);
}

gboolean calculator_handler_set_test_report (CalculatorIf * iface, gint32* _return, const gint32 ReportTime, GError ** error)
{
  g_return_val_if_fail (IS_CALCULATOR_HANDLER (iface), FALSE);

  return CALCULATOR_HANDLER_GET_CLASS (iface)->set_test_report (iface, _return, ReportTime, error);
}

gboolean calculator_handler_get_test_report (CalculatorIf * iface, gint32* _return, GError ** error)
{
  g_return_val_if_fail (IS_CALCULATOR_HANDLER (iface), FALSE);

  return CALCULATOR_HANDLER_GET_CLASS (iface)->get_test_report (iface, _return, error);
}
...
calculator_handler_calculator_if_interface_init (CalculatorIfInterface *iface)
{
  ...
  iface->get_log_type1 = calculator_handler_get_log_type1;
  iface->set_log_type1 = calculator_handler_set_log_type1;
  iface->set_test_report = calculator_handler_set_test_report;
  iface->get_test_report = calculator_handler_get_test_report;
...
{
  cls->ping = NULL;
  cls->get_log_type1 = NULL;
  cls->set_log_type1 = NULL;
  cls->set_test_report = NULL;
  cls->get_test_report = NULL;
  cls->add = NULL;
  cls->calculate = NULL;
  cls->zip = NULL;
}
...
calculator_processor_process_ping (CalculatorProcessor *,
                                   ...
                                   GError **);
static gboolean
calculator_processor_process_get_log_type1 (CalculatorProcessor *,
                                            gint32,
                                            ThriftProtocol *,
                                            ThriftProtocol *,
                                            GError **);
static gboolean
calculator_processor_process_set_log_type1 (CalculatorProcessor *,
                                            gint32,
                                            ThriftProtocol *,
                                            ThriftProtocol *,
                                            GError **);
static gboolean
calculator_processor_process_set_test_report (CalculatorProcessor *,
                                              gint32,
                                              ThriftProtocol *,
                                              ThriftProtocol *,
                                              GError **);
static gboolean
calculator_processor_process_get_test_report (CalculatorProcessor *,
                                              gint32,
                                              ThriftProtocol *,
                                              ThriftProtocol *,
                                              GError **);
...
calculator_processor_process_function_defs[8] = {
  {
    "ping",
  ...
  {
    "getLogType1",
    calculator_processor_process_get_log_type1
  },
  {
    "setLogType1",
    calculator_processor_process_set_log_type1
  },
  {
    "setTestReport",
    calculator_processor_process_set_test_report
  },
  {
    "getTestReport",
    calculator_processor_process_get_test_report
  },
  {
    "add",
...
static gboolean
calculator_processor_process_get_log_type1 (CalculatorProcessor *self,
                                            gint32 sequence_id,
                                            ThriftProtocol *input_protocol,
                                            ThriftProtocol *output_protocol,
                                            GError **error)
{
  ...
  ThriftTransport * transport;
  ThriftApplicationException *xception;
  CalculatorGetLogType1Args * args =
    g_object_new (TYPE_CALCULATOR_GET_LOG_TYPE1_ARGS, NULL);
  ...
  {
    gint return_value;
    CalculatorGetLogType1Result * result_struct;

    g_object_unref (transport);
    g_object_get (output_protocol, "transport", &transport, NULL);

    result_struct = g_object_new (TYPE_CALCULATOR_GET_LOG_TYPE1_RESULT, NULL);
    g_object_get (result_struct, "success", &return_value, NULL);

    if (calculator_handler_get_log_type1 (CALCULATOR_IF (self->handler),
                                          (gint32 *)&return_value,
                                          error) == TRUE)
    {
    ...
    {
      if (*error == NULL)
        g_warning ("Calculator.getLogType1 implementation returned FALSE "
                   "but did not set an error");
...
static gboolean
calculator_processor_process_set_log_type1 (CalculatorProcessor *self,
                                            gint32 sequence_id,
                                            ThriftProtocol *input_protocol,
                                            ThriftProtocol *output_protocol,
                                            GError **error)
{
  ...
  ThriftTransport * transport;
  ThriftApplicationException *xception;
  CalculatorSetLogType1Args * args =
    g_object_new (TYPE_CALCULATOR_SET_LOG_TYPE1_ARGS, NULL);
      ...
      (thrift_transport_read_end (transport, error) != FALSE))
  {
    gint logType1;
    gint return_value;
    CalculatorSetLogType1Result * result_struct;
    ...
    result_struct = g_object_new (TYPE_CALCULATOR_SET_LOG_TYPE1_RESULT, NULL);
    g_object_get (result_struct, "success", &return_value, NULL);

    if (calculator_handler_set_log_type1 (CALCULATOR_IF (self->handler),
                                          (gint32 *)&return_value,
                                          logType1,
                                          error) == TRUE)
    {
    ...
    {
      if (*error == NULL)
        g_warning ("Calculator.setLogType1 implementation returned FALSE "
                   "but did not set an error");
...
static gboolean
calculator_processor_process_set_test_report (CalculatorProcessor *self,
                                              gint32 sequence_id,
                                              ThriftProtocol *input_protocol,
                                              ThriftProtocol *output_protocol,
                                              GError **error)
{
  ...
  ThriftTransport * transport;
  ThriftApplicationException *xception;
  CalculatorSetTestReportArgs * args =
    g_object_new (TYPE_CALCULATOR_SET_TEST_REPORT_ARGS, NULL);
      ...
      (thrift_transport_read_end (transport, error) != FALSE))
  {
    gint ReportTime;
    gint return_value;
    CalculatorSetTestReportResult * result_struct;
    ...
    result_struct = g_object_new (TYPE_CALCULATOR_SET_TEST_REPORT_RESULT, NULL);
    g_object_get (result_struct, "success", &return_value, NULL);

    if (calculator_handler_set_test_report (CALCULATOR_IF (self->handler),
                                            (gint32 *)&return_value,
                                            ReportTime,
                                            error) == TRUE)
    {
    ...
    {
      if (*error == NULL)
        g_warning ("Calculator.setTestReport implementation returned FALSE "
                   "but did not set an error");
...
static gboolean
calculator_processor_process_get_test_report (CalculatorProcessor *self,
                                              gint32 sequence_id,
                                              ThriftProtocol *input_protocol,
                                              ThriftProtocol *output_protocol,
                                              GError **error)
{
  ...
  ThriftTransport * transport;
  ThriftApplicationException *xception;
  CalculatorGetTestReportArgs * args =
    g_object_new (TYPE_CALCULATOR_GET_TEST_REPORT_ARGS, NULL);
  ...
  {
    gint return_value;
    CalculatorGetTestReportResult * result_struct;

    g_object_unref (transport);
    g_object_get (output_protocol, "transport", &transport, NULL);

    result_struct = g_object_new (TYPE_CALCULATOR_GET_TEST_REPORT_RESULT, NULL);
    g_object_get (result_struct, "success", &return_value, NULL);

    if (calculator_handler_get_test_report (CALCULATOR_IF (self->handler),
                                            (gint32 *)&return_value,
                                            error) == TRUE)
    {
      g_object_set (result_struct, "success", (gint)(gint32)return_value, NULL);
    ...
    {
      if (*error == NULL)
        g_warning ("Calculator.getTestReport implementation returned FALSE "
                   "but did not set an error");
