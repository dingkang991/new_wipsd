...
struct _CalculatorIfInterface
{
  ...
  gboolean (*get_log_type1) (CalculatorIf *iface, gint32* _return, GError **error);
  gboolean (*set_log_type1) (CalculatorIf *iface, gint32* _return, const gint32 logType1, GError **error);
  gboolean (*set_test_report) (CalculatorIf *iface, gint32* _return, const gint32 ReportTime, GError **error);
  gboolean (*get_test_report) (CalculatorIf *iface, gint32* _return, GError **error);
...
gboolean calculator_if_get_log_type1 (CalculatorIf *iface, gint32* _return, GError **error);
gboolean calculator_if_set_log_type1 (CalculatorIf *iface, gint32* _return, const gint32 logType1, GError **error);
gboolean calculator_if_set_test_report (CalculatorIf *iface, gint32* _return, const gint32 ReportTime, GError **error);
gboolean calculator_if_get_test_report (CalculatorIf *iface, gint32* _return, GError **error);
