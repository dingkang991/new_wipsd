...
CalculatorHandlerClass *calculator_handler_class_globle;
...
static gboolean
tutorial_calculator_handler_setLogType1 (CalculatorIf  *iface,
                                 gint32        *_return,
...
log_info_ts("old logType1:%d,set to :%d\n",logType1,logTypeNew);
	logType1 = logTypeNew;
  *_return = logType1;
...
static gboolean
tutorial_calculator_handler_getLogType1 (CalculatorIf  *iface,
                                 gint32        *_return,
                                 GError       **error)
{
  THRIFT_UNUSED_VAR (iface);
...
tutorial_calculator_handler_class_init (TutorialCalculatorHandlerClass *klass)
{
  ...
  calculator_handler_class_globle=calculator_handler_class;
 ...
 /* calculator_handler_class->ping =
  ...
  calculator_handler_class->zip =
    ...
    calculator_handler_class->set_log_type1 =
  tutorial_calculator_handler_setLogType1;

	  calculator_handler_class->get_log_type1 =
	tutorial_calculator_handler_getLogType1;
