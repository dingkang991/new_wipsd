...
#include "log.h"
#define log_info(format,...) LOG("hash",HASH,0,LEVEL_INFO,format,  ##__VA_ARGS__)
#define log_debug(format,...) LOG("hash",HASH,0,LEVEL_DEBUG,format,  ##__VA_ARGS__)
#define log_error(format,...) LOG("hash",HASH,0,LEVEL_ERROR,format,  ##__VA_ARGS__)
#define log_warn(format,...) LOG("hash",HASH,0,LEVEL_WARN,format,  ##__VA_ARGS__)
#define WIPSD_DEBUG(format,...) LOG("hash",HASH,0,LEVEL_DEBUG,format,  ##__VA_ARGS__)
