...
#define IEEE80211_REDIRECT_URL_MAX_LEN  128
enum white_ip_type
{
    WHITE_IP_HOST = 0,
    WHITE_IP_RANGE,
...
struct ip_address_host {
	u_int32_t ip_addr;
    u_int32_t reserv;
};
struct ip_address_range {
	u_int32_t ip_begin;
    u_int32_t ip_end;
};
struct ip_address_mask {
	u_int32_t ip_addr;
    u_int32_t ip_mask;
};

struct ip_address_obj
{
    struct list_head list;

    u_int32_t type;
    union{
        struct ip_address_host ip_host;
        struct ip_address_range ip_range;
        struct ip_address_mask ip_mask;
    }data;
};
...
#define PROC_FNAME_SIZE 20
	...
	u_int8_t                   iv_portal_enable;
    u_int8_t                   iv_portal_id;
    u_int8_t                   iv_is_auto_portal;
    u_int8_t                   iv_portal_url[IEEE80211_REDIRECT_URL_MAX_LEN];
	struct list_head           iv_white_ip_list;
    u_int8_t                   iv_no_avoid_block;
    u_int8_t                   iv_vap_monitor;
/*
